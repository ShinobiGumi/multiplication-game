...
const mostFrequentWords: HiraganaCharacter[] = [
  { character: 'これ', romaji: 'kore' }, { character: 'それ', romaji: 'sore' }, { character: 'あれ', romaji: 'are' }, { character: 'です', romaji: 'desu' }, { character: 'ます', romaji: 'masu' }, { character: 'ぼく', romaji: 'boku' }, { character: 'ようこ', romaji: 'youko' }, { character: 'かるろ', romaji: 'karuro' }, { character: 'るい', romaji: 'rui' }, { character: 'あいさつ（挨拶）, romaji: 'aisatsu (greeting)' },  { character: 'ありがとう（感謝表現・検索結果に含まれないが必須語）, romaji: 'arigatou (thank you)' },  { character: 'ごめんなさい（謝罪表現）, romaji: 'gomennasai (sorry)' },  { character: 'こんにちは（挨拶）, romaji: 'konnichiha (hello)' },  { character: 'おはよう（朝の挨拶）, romaji: 'ohayou (good morning)' },  { character: 'さようなら（別れの挨拶）, romaji: 'sayounara (good bye)' },  { character: 'はい, romaji: 'hai (yes)' },  { character: 'いいえ（否定応答）, romaji: 'iie (no)' },  { character: 'ともだち（友達）, romaji: 'tomodachi (friend)' },  { character: 'がっこう（学校）, romaji: 'gakkou (school)' },  { character: 'せんせい（先生）, romaji: 'sensei (teacher)' },  { character: 'えんぴつ（鉛筆・検索結果外だが必須）, romaji: 'enpitsu (pencil)' },  { character: 'ほん（本）, romaji: 'hon (book)' },  { character: 'ノート, romaji: 'nooto (notebook)' },  { character: 'かばん, romaji: 'kaban (bag)' },  { character: 'おかあさん（お母さん）, romaji: 'okaasan (mama)' },  { character: 'おとうさん（お父さん）, romaji: 'otousan (papa)' },  { character: 'きょうだい（兄弟・検索結果外）, romaji: 'kyoudai (sibling)' },  { character: 'いぬ（犬）, romaji: 'inu (dog)' },  { character: 'ねこ（猫）, romaji: 'neko (cat)' },  { character: 'おちゃ（お茶）, romaji: 'ocha (tea)' },  { character: 'おかし（お菓子）, romaji: 'okashi (candy)' },  { character: 'ごはん（食事/米）, romaji: 'gohan (rice)' },  { character: 'みず（水）, romaji: 'mizu (water)' },  { character: 'おかね（お金）, romaji: 'okane (money)' },  { character: 'でんわ（電話）, romaji: 'denwa (phone)' },  { character: 'テレビ, romaji: 'terebi (television)' },  { character: 'ゲーム, romaji: 'geemu (game)' },  { character: 'スポーツ（運動）, romaji: 'supootsu (sports)' },  { character: 'サッカー, romaji: 'sakkaa (soccer)' },  { character: 'やきゅう（野球）, romaji: 'yakyuu (baseball)' },  { character: 'プール, romaji: 'puuru (pool)' },  { character: 'え（絵）, romaji: 'e (painting, drawing)' },  { character: 'うた（歌）, romaji: 'uta (song)' },  { character: 'おんがく（音楽）, romaji: 'ongaku (music)' },  { character: 'がっき（楽器・検索結果外）, romaji: 'gakki (musical instrument)' },  { character: 'つくえ（机）, romaji: 'tsukue (desk)' },  { character: 'いす（椅子）, romaji: 'isu (chair)' },  { character: 'えんそく（遠足・検索結果外）, romaji: 'ensoku (school outing)' },  { character: 'しゅくだい（宿題）, romaji: 'shukudai (homework)' },  { character: 'べんきょう（勉強）, romaji: 'benkyou (study)' },  { character: 'テスト, romaji: 'tesuto (test)' },  { character: 'やすみ（休み）, romaji: 'yasumi (rest)' },  { character: 'あそぶ（遊ぶ）, romaji: 'asobu (play)' },  { character: 'いく（行く）, romaji: 'iku (to go)' },  { character: 'くる（来る）, romaji: 'kuru (to come)' },  { character: 'たべる（食べる）, romaji: 'taberu (to eat)' },  { character: 'のむ（飲む）, romaji: 'nomu (to drink)' },  { character: 'ねる（寝る）, romaji: 'neru (to sleep)' },
];
// --- End Hiragana Data ---
