...
const mostFrequentWords: HiraganaCharacter[] = [
  { character: 'これ', romaji: 'kore' }, { character: 'それ', romaji: 'sore' }, { character: 'あれ', romaji: 'are' }, { character: 'です', romaji: 'desu' }, { character: 'ます', romaji: 'masu' }, { character: 'ぼく', romaji: 'boku' }, { character: 'ようこ', romaji: 'youko' }, { character: 'かるろ', romaji: 'karuro' }, { character: 'るい', romaji: 'rui' },  { character: 'あいさつ（挨拶）', romaji: 'aisatsu' }, { character: 'ありがとう', romaji: 'arigatou' }, { character: 'ごめんなさい', romaji: 'gomennasai' }, { character: 'こんにちは（挨拶）', romaji: 'konnichiha' }, { character: 'おはよう', romaji: 'ohayou' }, { character: 'さようなら', romaji: 'sayounara' }, { character: 'はい', romaji: 'hai' }, { character: 'いいえ', romaji: 'iie' }, { character: 'ともだち（友達）', romaji: 'tomodachi' }, { character: 'がっこう（学校）', romaji: 'gakkou' }, { character: 'せんせい（先生）', romaji: 'sensei' }, { character: 'えんぴつ(鉛筆)', romaji: 'enpitsu' }, { character: 'ほん（本）', romaji: 'hon' }, { character: 'ノート', romaji: 'nooto' }, { character: 'かばん', romaji: 'kaban' }, { character: 'おかあさん（お母さん）', romaji: 'okaasan' }, { character: 'おとうさん（お父さん）', romaji: 'otousan' }, { character: 'きょうだい(兄弟)', romaji: 'kyoudai' }, { character: 'いぬ（犬）', romaji: 'inu'}, { character: 'ねこ（猫）', romaji: 'neko' }, { character: 'おちゃ（お茶）', romaji: 'ocha' }, { character: 'おかし（お菓子）', romaji: 'okashi' }, { character: 'ごはん（食事/米）', romaji: 'gohan' }, { character: 'みず（水）', romaji: 'mizu' }, { character: 'おかね（お金）', romaji: 'okane' }, { character: 'でんわ（電話）', romaji: 'denwa' }, { character: 'テレビ', romaji: 'terebi' }, { character: 'ゲーム', romaji: 'geemu' }, { character: 'スポーツ（運動）', romaji: 'supootsu' }, { character: 'サッカー', romaji: 'sakkaa' }, { character: 'やきゅう（野球）', romaji: 'yakyuu' }, { character: 'プール', romaji: 'puuru' }, { character: 'え（絵）', romaji: 'e' }, { character: 'うた（歌）', romaji: 'uta' }, { character: 'おんがく（音楽）', romaji: 'ongaku' }, { character: 'がっき', romaji: 'gakki' }, { character: 'つくえ（机）', romaji: 'tsukue' }, { character: 'いす（椅子）', romaji: 'isu' }, { character: 'えんそく（遠足）', romaji: 'ensoku' }, { character: 'しゅくだい（宿題）', romaji: 'shukudai' }, { character: 'べんきょう（勉強）', romaji: 'benkyou' }, { character: 'テスト', romaji: 'tesuto' }, { character: 'やすみ（休み）', romaji: 'yasumi' }, { character: 'あそぶ（遊ぶ）', romaji: 'asobu' }, { character: 'いく（行く）', romaji: 'iku' }, { character: 'くる（来る）', romaji: 'kuru' }, { character: 'たべる（食べる）', romaji: 'taberu' }, { character: 'のむ（飲む）', romaji: 'nomu' }, { character: 'ねる（寝る）', romaji: 'neru' }, 
];
// --- End Hiragana Data ---
